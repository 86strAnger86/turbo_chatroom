class Message < ApplicationRecord
  ...
  def validate_attachment_filetypes
    ...
    attachments.each do |attachment|
      puts "AHHHTUUNNGGGG!!!!: #{attachment.content_type}"
      unless attachment.content_type.in?(%w[image/jpeg image/png image/gif video/mp4 video/mpeg audio/x-wav audio/ogg audio/webm])
